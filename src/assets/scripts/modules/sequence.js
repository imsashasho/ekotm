...
//   containerArg,
//   path = '/wp-content/themes/bogun/assets/images/home/screen2-sequence/',
//   frames = 120,
//   reverse,
// ) {
...
//         e.type === 'touchmove'
//           ? (
//               (e.targetTouches[0].clientX * imagesCount) /
//               document.documentElement.clientWidth
//             ).toFixed()
//           : (
//               ((e.clientX - cords.start) * imagesCount) /
//               (document.documentElement.clientWidth * cords.scale)
//             ).toFixed();
...
//     if (loadedCounter < imagesCount - 1) return;
//     const posInPercent = Math.floor(
//       (e.clientX * imagesCount) / document.documentElement.clientWidth,
//     );
//     // console.log('fff');
//     window.requestAnimationFrame(() => {
//       const cords = getAmplitudeOfMoving();
...
//     if (loadedCounter < imagesCount - 1) return;
//     const posInPercent = Math.floor(
//       (e.targetTouches[0].clientX * imagesCount) / document.documentElement.clientWidth,
//     );
//     window.requestAnimationFrame(() => {
//       changeImage(posInPercent);
//     });
//   });
//   gsap.set(containerToAdd.parentElement, {
//     webkitPerspective: 100 /*webkitTransformStyle:"preserve-3d"*/,
//   });
...
export default function fake3d(
  containerArg,
  path = 'wp-content/themes/romankiv/static/romankiv.json',
  frames = 120,
) {
  // if (window.matchMedia('(max-width: 575px)').matches) return;
  const containerToAdd = document.createElement('img');
